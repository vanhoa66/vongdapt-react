...
import { categorysRef } from './../firebase';
...
class Slider extends Component {
  ...
  componentWillMount() {
    categorysRef.on('value', categorys => {
      let data = [];
      categorys.forEach(category => {
        const { name } = category.val();
        data.push({ name, key: category.key });
      })
  ...
  showCategory(categorys) {
    ...
    if (categorys.length > 0) {
      xhml = categorys.map((category, index) => {
  ...
  render() {
    ...
    return (
      <div className="menu-slider-area">
        <div className="container">{/*Start Menu area*/}
          <div className="row">{/*Start Menu area*/}
            <div className="col-md-3 col-lg-2 main-menu-2-pre">{/*Start Menu area*/}
              <div className="main-menu-2 hidden-sm hidden-xs">
                <nav>
                  <ul>
                ...
                {/* <nav>
                  <ul>
                    ...
                    <li><a href=" ">Pages</a>
                      <div className="mega-menu mega-menu-2 mega-menu-page">
                    ...
                    <li><a href="shop.html">Shop</a>
                      <div className="mega-menu mega-menu-2">
                        ...
                        <div className="column-4 column">
                          <a href=" "><img src="img/product/10.jpg" alt="vong da phong thuy" /></a>
                        </div>
                      </div>
                    </li>
            ...
            <div className="home-3-slider col-md-9 col-lg-10">
              ...
              <div id="htmlcaption1" className="nivo-html-caption slider-caption-1">
                ...
                <div className="slide1-text slide-text">
                  <div className="middle-text">
                    ...
                    <div className="cap-dec wow slideInRight" data-wow-duration="1.3s" data-wow-delay="0s">
                      <h2>to express personality</h2>
                    </div>
                    <div className="cap-readmore wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0s">
                      <a href=" ">Shop Now</a>
                    </div>
                  </div>
                </div>
              ...
              <div id="htmlcaption2" className="nivo-html-caption slider-caption-2">
                <div className="slider-progress" />
                <div className="slide2-text slide-text">
                  <div className="middle-text">
                    <div className="cap-title wow bounceInDown" data-wow-duration=".9s" data-wow-delay="0s">
                      <h1>Exclusive Jewelry</h1>
                    </div>
                    <div className="cap-dec wow bounceInRight" data-wow-duration="1.5s" data-wow-delay="0s">
                      <h2>to express personality</h2>
                    </div>
                    <div className="cap-readmore wow bounceInUp" data-wow-duration="1.3s" data-wow-delay=".5s">
                      <a href=" ">Shop Now</a>
                    </div>
                  </div>
                </div>
